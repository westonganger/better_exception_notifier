...
class IrcNotifierTest < ActiveSupport::TestCase
  ...
  test 'should not send irc notification if badly configured' do
    ...
    irc = BetterExceptionNotifier::IrcNotifier.new(wrong_params)

...
class EmailNotifierTest < ActiveSupport::TestCase
  setup do
    ...
    @exception.set_backtrace(['test/better_exception_notifier/email_notifier_test.rb:20'])

    @email_notifier = BetterExceptionNotifier::EmailNotifier.new(
  ...
  test 'sends mail with correct content' do
    ...
    body = <<-BODY.gsub(/^      /, '')
      A ZeroDivisionError occurred in background at Sat, 20 Apr 2013 20:58:55 UTC +00:00 :
        ...
        divided by 0
        test/better_exception_notifier/email_notifier_test.rb:20
  ...
  test 'should normalize multiple digits into one N' do
    assert_equal 'N foo N bar N baz N',
                 BetterExceptionNotifier::EmailNotifier.normalize_digits('1 foo 12 bar 123 baz 1234')
  end
  ...
  test 'should not send notification if one of ignored exceptions' do
    begin
      ...
      @ignored_exception = e
      unless BetterExceptionNotifier.ignored_exceptions.include?(@ignored_exception.class.name)
